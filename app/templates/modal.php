<div class="modal box sm:column-6 md:column-5 is-centered m-0-a px-3 text-ink pin top left columns absolute" id="modal">
	<button class="pin right top mt-1 mr-2 text-grey-dark" onclick="closeModal()">x (esc)</button>

	<header class="column column-12 is-centered text-primary mb-3 w-100">
...
<div class="modal box sm:column-8 md:column-6 lg:column-4 is-centered m-0-a px-3 text-ink pin top left columns absolute" id="modal_confirm">
	...
	<header class="text-centered text-primary mb-3 w-100">
		...
		<div class="sm:column-9 text-left m-0-a b-1 b-grey-lighter px-2 py-2">
			...
			<p class="text-grey text-xs">PASS:  <code class="text-purple ml-1 mb-3 text-sm" id="passphrase"></code></p>
